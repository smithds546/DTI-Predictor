"""
Iteration 1 — Mini-batch gradient descent
Improvement over basic: full-batch GD → mini-batch GD (batch_size=256)
Everything else unchanged: small random init, sigmoid hidden, no early stopping.
"""
...
def main():
    ...
    basic_path = os.path.join(os.path.dirname(__file__),
                              "../../basic/figures/basic_test_metrics.json")
    baseline = load_metrics(basic_path, label="basic/run.py")
