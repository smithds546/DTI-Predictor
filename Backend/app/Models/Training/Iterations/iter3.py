"""
Iteration 3 — ReLU hidden activation
Adds to iter2: ReLU in the hidden layer replacing sigmoid.
Everything else unchanged: He init, mini-batch GD, no early stopping.
"""
...
def main():
    ...
    # ── Figures ───────────────────────────────────────────────────────────
    # Save test metrics for iter4 to diff against
    import json
