    ...
    <Layout>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <strong>Ethical Considerations:</strong> This tool is intended for <strong>academic and research purposes only</strong>.
          Predictions are generated by a machine learning model and should not be treated as definitive or clinically actionable.
          Results may contain inaccuracies and must be validated through experimental methods before informing any decision-making.
          This tool is not a substitute for professional pharmacological or medical advice.
        </div>
