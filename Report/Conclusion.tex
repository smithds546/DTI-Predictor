...
When evaluated with an increased sample size, the model achieved an AUROC of approximately 0.97, exceeding both MINDG (~0.95) and DeepCDA (~0.89) across all reported metrics.
...
Second, an iterative developement methodology which shows incremental improvements and provides transparency on how architectural, training, and framework decisions impact model performance.
