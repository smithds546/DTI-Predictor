...
A subset of interactions classified as weak binders or non-binders, $5.3 \leq \mathrm{pAffinity} \leq 7.0$ and defined as the \textit{grey area}, is removed from the dataset to reduce label noise.
...
The model achieves an AUC-ROC of approximately 0.97 and an F1 score of 0.87 at decision threshold $\tau = 0.3$, exceeding the headline AUCs reported by MINDG (0.95) and DeepCDA (0.89), though direct comparison is limited by differences in dataset scale and evaluation protocol.
...
I would like to thank my supervisor for their guidance and support throughout the year.