...
The sigmoid is applied only at inference, to map the raw logit to a probability. During training, BCEWithLogitsLoss applies sigmoid internally when computing the loss for numerical stability.
Here is a table describing the architecture of the prediction network:
  \begin{table}[H]
  \centering
