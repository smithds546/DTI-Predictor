...
Here is a tale describing the architecture of the prediction network:
  ...
  \quad LR scheduler         & CosineAnnealingLR(T\_max=100, eta\_min=1e-5) \\
  \bottomrule
  \end{tabular}
  \end{table}
