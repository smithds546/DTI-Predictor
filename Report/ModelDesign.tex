...
As shown in Table~\ref{tab:network_structure}, we are using mostly defaults set by Adam optimiser.
...
The weight decay parameter was set to $1\times10^{-4}$, which helps to prevent overfitting by adding a penalty on large weights, encouraging the model to learn simpler patterns that generalise better to unseen data.
